...
@ActiveProfiles("test")
@Transactional
public class OrderTransitionBlackBoxTest {
    ...
    void setUp() throws Exception {
        ...
        orderSubmitDTO.setDeliveryStatus(1);
...
//        shoppingCartDTO.setDishFlavor("微辣"); // 可选的口味信息
    ...
    void testTC3_AfterAccept2CancelRefundFlow() throws Exception {
    ...
    @Test
    @DisplayName("TC4：商家拒单流程")
    void testTC4_MerchantRejectFlow() throws Exception {
    ...
    void testTC5_CancelAfterCompletionFlow() throws Exception {
    ...
    void testValidMerchantRejectOrderBeforeAccept() throws Exception {
